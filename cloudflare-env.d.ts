/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 444e52b5a4a25425fa76c2c76a88a545)
// Runtime types generated with workerd@1.20260811.1 2026-08-11 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	ASSETS: Fetcher;
	CHAT_LOCAL_DEV: "false";
	CHAT_REALTIME_ENABLED: "true";
	TURNSTILE_SECRET_KEY: string;
	ADMIN_PASSWORD: string;
	ADMIN_SESSION_SECRET: string;
	CHAT_CONVERSATIONS: DurableObjectNamespace<import("./custom-worker").ChatConversation>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./custom-worker");
		durableNamespaces: "ChatConversation";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHAT_LOCAL_DEV" | "CHAT_REALTIME_ENABLED" | "TURNSTILE_SECRET_KEY" | "ADMIN_PASSWORD" | "ADMIN_SESSION_SECRET">> {}
}
