...
const items = [
  {
    ...
    className:
      'absolute top-[18%] left-[8%] z-10 rotate-[-4deg] sm:top-10 sm:left-[20%] sm:rotate-[-5deg]',
  },
  {
    title: 'Melody',
    image: mediaUrl('fnds/02-melody.jpg'),
    className:
      'absolute top-[27%] left-[13%] z-10 rotate-[-6deg] sm:top-40 sm:left-[25%] sm:rotate-[-7deg]',
  },
  {
    title: '我们',
    image: mediaUrl('fnds/03-wo-men.jpg'),
    className:
      'absolute top-[20%] left-[16%] z-10 rotate-[5deg] sm:top-5 sm:left-[40%] sm:rotate-[8deg]',
  },
  {
    title: '杭州站',
    image: mediaUrl('fnds/04-hang-zhou.jpg'),
    className:
      'absolute top-[30%] left-[10%] z-10 rotate-[6deg] sm:top-32 sm:left-[55%] sm:rotate-[10deg]',
  },
  {
    title: '任我行',
    image: mediaUrl('fnds/05-ren-wo-xing.jpg'),
    className:
      'absolute top-[24%] left-[6%] z-10 rotate-[2deg] sm:top-20 sm:right-[35%] sm:left-auto',
  },
  {
    title: '澳门8.3',
    image: mediaUrl('fnds/06-ao-men.jpg'),
    className:
      'absolute top-[32%] left-[15%] z-10 rotate-[-5deg] sm:top-24 sm:left-[45%] sm:rotate-[-7deg]',
  },
  {
    title: '忽然007',
    image: mediaUrl('fnds/07-hu-ran-007.jpg'),
    className:
      'absolute top-[22%] left-[12%] z-10 rotate-[3deg] sm:top-8 sm:left-[30%] sm:rotate-[4deg]',
  },
]
...
export default function FndsPage() {
  ...
  return (
    <DraggableCardContainer
      ref={containerRef}
      className="relative flex min-h-0 w-full flex-1 items-center justify-center overflow-clip"
    >
      <div className="pointer-events-none absolute inset-x-0 top-[48%] z-0 flex -translate-y-1/2 flex-col items-center text-center select-none sm:top-1/2 sm:-translate-y-3/4">
